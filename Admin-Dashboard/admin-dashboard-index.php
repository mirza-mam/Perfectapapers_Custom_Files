			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8">
						<h1 class="float-left text-center text-md-left">Admin Dashboard</h1>
					</div>
							...
							<div class="col-md-12 col-lg-8">
								...
								<div class="card mb-4">
									<div class="card-block">
										...
										<h6 class="card-subtitle mb-2 text-muted"> Hi! <?php echo $user_data_row['user_name']; ?> below is the overview of your website</h6>
										...
										<div class="articles-container">
												...
												<div class="col-xs-12">
													<div class="row">
														<div class="col-2 date">
															<div class="large"><?php echo mysqli_num_rows($total_orders); ?></div>
														</div>
														<div class="col-10">
															<h4><a href="#"> Total Orders </a></h4>
														</div>
													</div>
												</div>
												<div class="clear"></div>
											...
											<div class="article">
												<div class="col-xs-12">
													<div class="row">
														<div class="col-2 date">
															<div class="large"><?php echo mysqli_num_rows($available_leads); ?></div>
														</div>
														<div class="col-10">
											...
											<div class="article">
												<div class="col-xs-12">
													<div class="row">
														<div class="col-2 date">
															<div class="large"><?php echo mysqli_num_rows($upaid_orders); ?></div>
														</div>
														<div class="col-10">
												...
												<div class="col-xs-12">
													<div class="row">
														<div class="col-2 date">
															...
															<div class="large"><?php echo mysqli_num_rows($sales_man); ?></div>

														</div>
														<div class="col-10">
															<h4><a href="#">Sales Man</a></h4>
														</div>
													</div>
												</div>
												<div class="clear"></div>
												...
												<div class="col-xs-12">
													<div class="row">
														<div class="col-2 date">
															...
															<div class="large"><?php echo mysqli_num_rows($customers); ?></div>

														</div>
														<div class="col-10">
															<h4><a href="#">Cutomers</a></h4>
														</div>
													</div>
												</div>
												<div class="clear"></div>
