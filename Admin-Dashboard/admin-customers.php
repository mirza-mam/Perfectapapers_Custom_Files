			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8">
						<h1 class="float-left text-center text-md-left">Customers</h1>
					</div>
							...
							<div class="col-sm-12 col-md-12">
								...
								<div class="card mb-4">
									<div class="card-block">
										<h3 class="card-title">List Of Customers & Their Details</h3>
									</div>
									<div class="table-responsive">
										<table class="table table-striped">
											...
											<tbody>
												...
												$coustomer = $obj->show_all_data("0");
												while ($coustomer_data_row = mysqli_fetch_assoc($coustomer)) {

												?>

													<tr>
														<td> <?php echo $coustomer_data_row['user_id']; ?> </td>
														<td> <?php echo $coustomer_data_row['user_name']; ?> </td>
														<td> <?php echo $coustomer_data_row['user_email']; ?> </td>
														<td> <?php echo $coustomer_data_row['user_contact']; ?> </td>
														<td> NA </td>
														<td> NA </td>
