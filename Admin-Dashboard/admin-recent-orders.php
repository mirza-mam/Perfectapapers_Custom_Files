...
<body>
													...
													<div class="dropdown">
													  ...
													  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
														...
														<a class="dropdown-item" href="#">Assign to</a>
													  	...
													  	<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal_for_changing_payment_status" id="<?php echo $orders_data_row['order_id']; ?>">Paid</a>
  ...
  <div class="modal fade" id="modal_for_changing_payment_status">
	...
	<p> Are you sure that you want to change the payment status of Order# <span id="r_order_id"> </span> to Paid!! </p>
		...
		//This function is used to throw the ID of that anchor tag which triggers the Changing Payment Status Modal
		 ...
		 $("#change_r_order_payment_status_btn").click(
			 ...
			 function(){ 
				 ...
				 $.ajax({
					url: "admin-change-payment-status.php",
					type: "POST",
					data: {order_id: v},
					success: function(r){
						//alert(r);
