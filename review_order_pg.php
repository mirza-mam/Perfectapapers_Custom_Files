...
-->
					...
					<div>
				<button type="button" name="Proceed_To_Check_Out_btn" onclick="window.open('PaymentMethodForm.php?P_T_Chk_O_bt=1')" class="checkout-btn"> <span class="fa fa-shopping-cart"></span> Proceed To Check Out</button> <!--  data-toggle="modal" data-target="#user_checkout_modal" -->
					</div>
