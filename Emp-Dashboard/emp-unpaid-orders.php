							...
							<div class="col-sm-12 col-md-12">
								...
								<div class="card mb-4">
									<div class="card-block">
										<h3 class="card-title text-danger">UnPaid Orders List</h3>
									</div>
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td> <?php echo $orders_data_row['doc_type']; ?> </td>
														<td> <?php echo $orders_data_row['academic_lvl']; ?> </td>
														<td> <?php echo $orders_data_row['no_of_pages']; ?> </td>
														<td> <?php echo $orders_data_row['deadline_time']; ?> </td>
														...
														<td> <?php echo $orders_data_row['order_placing_date']; ?> </td>
														<td> <?php echo $orders_data_row['order_placing_time']; ?> </td>
													</tr>
												<?php  		} ?>
											</tbody>
										</table>
