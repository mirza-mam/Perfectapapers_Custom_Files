...
class fetch_and_show extends super_person{
	...
	$q_result = $this->run_query("SELECT * FROM temp_order_tbl ORDER BY order_id DESC"); 
	...
	public function show_all_data( $given_val ){
		...
		if( $given_val == "Completed" || $given_val == "InProgress" || $given_val == "Revisions" )
		{
		...
		{
			$q_result = $this->run_query( "SELECT * FROM users_tbl");
		}
